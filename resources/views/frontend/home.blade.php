            ...
            <div class="content">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 offset-lg-1  order-0">
                        <figure>
                            <img src="{{ asset('frontend/images/h-banner-img.png') }}" class="img-fluid" alt=""
                                srcset="">
                        </figure>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-auto col-md-4 col-6">
                        <div class="major-card">
                            ...
                            <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">{{$major->name}}</h4>
                        </div>
                    </div>
                    @endforeach
                    <!-- <div class="col-lg-auto col-md-4 col-6">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="hospital-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                    ...
                                    <div class="hospital-rate">
                                        ...
                                        <p>(55) تقييم | {{ $hospital->location }}</p>
                                    </div>
                                    <h4>{{ $hospital->name }}</h4>
                                </div>
                            </div>
        ...
        <div class="container">
            <div class="content">
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <figure>
                            <img src="{{ asset('frontend/images/consultation.png') }}" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="col-lg-7">
        ...
        <div class="container">
            <div class="content">
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <figure>
                            <img src="{{ asset('frontend/images/contact-us.png') }}" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="col-lg-7">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="blog-details.html">
                            <div class="article-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                <figure>
                                    <img src="{{ asset('frontend/images/article1.png') }}" alt=""
                                        srcset="">
                                </figure>
            ...
            <div class="content">
                <div class="d-flex align-items-center flex-wrap gap-3">
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="{{ asset('frontend/images/partner-1.png') }}" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="{{ asset('frontend/images/partner-2.png') }}" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.2s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="{{ asset('frontend/images/partner-3.png') }}" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.3s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="{{ asset('frontend/images/partner-4.png') }}" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.4s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="{{ asset('frontend/images/partner-5.png') }}" class="wow zoomIn"
