<?php $__env->startSection('content'); ?>
            ...
            <div class="content">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 offset-lg-1  order-0">
                        <figure>
                            <img src="<?php echo e(asset('frontend/images/h-banner-img.png')); ?>" class="img-fluid" alt=""
                                srcset="">
                        </figure>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-auto col-md-4 col-6">
                        <div class="major-card">
                            <figure>
                                <img src="<?php echo e(Storage::url('majors/' . $major->cover)); ?>" class="wow zoomIn"
                                    data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                            </figure>
                            <h4 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s"><?php echo e($major->name); ?></h4>
                        </div>
                    </div>
                    ...
                    <!-- <div class="col-lg-auto col-md-4 col-6">
                                <div class="major-card">
                                    <figure>
                                        <img src="frontend/images/major-11.svg" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                                    </figure>
                            ...
                            <div class="col-lg-auto col-md-4 col-6">
                                <div class="major-card">
                                    <figure>
                                        <img src="frontend/images/major-12.svg" class="wow zoomIn" data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                                    </figure>
                        ...
                        <?php $__currentLoopData = $hospitals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hospital): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-4 col-md-6">
                                <div class="hospital-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                    <figure>
                                        <img src="<?php echo e(Storage::url('hospitals/' . $hospital->cover)); ?>" alt=""
                                            srcset="">
                                    </figure>
                                    <div class="hospital-rate">
                                        ...
                                        <p>(55) تقييم | <?php echo e($hospital->location); ?></p>
                                    </div>
                                    <h4><?php echo e($hospital->name); ?></h4>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="general-card specialist-card wow fadeInUp" data-wow-duration="1s"
                            data-wow-delay="0.1s">
                            <figure>
                                <img src="<?php echo e(Storage::url('doctors/'.$doctor->cover)); ?>" alt="" srcset="">
                            </figure>
                            <div class="general-card-body">
                                <h4><?php echo e($doctor->name); ?></h4>
                                <h6><?php echo e($doctor->hospital->name); ?></h6>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="general-card why-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/why-1.svg')); ?>" alt="" srcset="">
                            </figure>
                            <div class="general-card-body">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="general-card why-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/why-2.svg')); ?>" alt="" srcset="">
                            </figure>
                            <div class="general-card-body">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="general-card why-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/why-3.svg')); ?>" alt="" srcset="">
                            </figure>
                            <div class="general-card-body">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="general-card why-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/why-4.svg')); ?>" alt="" srcset="">
                            </figure>
                            <div class="general-card-body">
        ...
        <div class="container">
            <div class="content">
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <figure>
                            <img src="<?php echo e(asset('frontend/images/consultation.png')); ?>" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="col-lg-7">
                ...
                <div class="owl-carousel rates-slider owl-slider">
                    <div class="rates-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                        ...
                        <div class="rates-card-info">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/avatar.png')); ?>" alt="" srcset="">
                            </figure>
                            <div>
                    ...
                    <div class="rates-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <div class="rates-card-info">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/avatar-2.png')); ?>" alt="" srcset="">
                            </figure>
                            <div>
                                <h4>رقية الشافعي</h4>
                                <h6>‏14 يوليو، 2022</h6>
                    ...
                    <div class="rates-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                        ...
                        <div class="rates-card-info">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/avatar-3.png')); ?>" alt="" srcset="">
                            </figure>
                            <div>
                                <h4>عبير العمري</h4>
                                <h6>‏21 يونيو، 2022</h6>
        ...
        <div class="container">
            <div class="content">
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <figure>
                            <img src="<?php echo e(asset('frontend/images/medical-health-services.png')); ?>" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="col-lg-7">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="#">
                            <div class="offer-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                <figure>
                                    <img src="<?php echo e(asset('frontend/images/offer-1.png')); ?>" alt="" srcset="">
                                    <div class="discount">
                                        ‏20% خصم
                                    </div>
                                </figure>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="#">
                            <div class="offer-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                <figure>
                                    <img src="<?php echo e(asset('frontend/images/offer2.png')); ?>" alt="" srcset="">
                                    <div class="discount">
                                        ‏25% خصم
                                    </div>
                                </figure>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="#">
                            <div class="offer-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                                <figure>
                                    <img src="<?php echo e(asset('frontend/images/offer3.png')); ?>" alt="" srcset="">
                                    <div class="discount">
                                        ‏15% خصم
                                    </div>
                                </figure>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <a href="#">
                            <div class="offer-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                                <figure>
                                    <img src="<?php echo e(asset('frontend/images/offer4.png')); ?>" alt="" srcset="">
                                    <div class="discount">
                                        ‏30% خصم
                                    </div>
                                </figure>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/standers-1.png')); ?>" alt="" srcset="">
                            </figure>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/standers-2.png')); ?>" alt="" srcset="">
                            </figure>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/standers-3.png')); ?>" alt="" srcset="">
                            </figure>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.4s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/standers-4.png')); ?>" alt="" srcset="">
                            </figure>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/standers-5.png')); ?>" alt="" srcset="">
                            </figure>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="standers-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.6s">
                            <figure>
                                <img src="<?php echo e(asset('frontend/images/standers-6.png')); ?>" alt="" srcset="">
                            </figure>
        ...
        <div class="container">
            <div class="content">
                <div class="row align-items-center">
                    <div class="col-lg-2">
                        <figure>
                            <img src="<?php echo e(asset('frontend/images/contact-us.png')); ?>" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="col-lg-7">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="blog-details.html">
                            <div class="article-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.1s">
                                <figure>
                                    <img src="<?php echo e(asset('frontend/images/article1.png')); ?>" alt=""
                                        srcset="">
                                </figure>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="blog-details.html">
                            <div class="article-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.2s">
                                <figure>
                                    <img src="<?php echo e(asset('frontend/images/article-2.png')); ?>" alt=""
                                        srcset="">
                                </figure>
                                <div class="article-card-body">
                                    <h6>‏12 أغسطس، 2022 - طب العيون</h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="blog-details.html">
                            <div class="article-card wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">
                                <figure>
                                    <img src="<?php echo e(asset('frontend/images/article-3.png')); ?>" alt=""
                                        srcset="">
                                </figure>
                                <div class="article-card-body">
                                    <h6>‏12 أغسطس، 2022 - طب العيون</h6>
            ...
            <div class="content">
                <div class="d-flex align-items-center flex-wrap gap-3">
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="<?php echo e(asset('frontend/images/partner-1.png')); ?>" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.1s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="<?php echo e(asset('frontend/images/partner-2.png')); ?>" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.2s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="<?php echo e(asset('frontend/images/partner-3.png')); ?>" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.3s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="<?php echo e(asset('frontend/images/partner-4.png')); ?>" class="wow zoomIn"
                                data-wow-duration="1s" data-wow-delay="0.4s" alt="" srcset="">
                        </figure>
                    </div>
                    <div class="partner-card">
                        <figure class="scale">
                            <img src="<?php echo e(asset('frontend/images/partner-5.png')); ?>" class="wow zoomIn"
    ...
    <div class="contact-us-btn">
        <a href="#">
            <figure>
                <img src="<?php echo e(asset('frontend/images/contact-us-icon.svg')); ?>" alt="" srcset="">
            </figure>
        </a>
        <p>طلب مساعدة</p>
    </div>
...
<?php echo $__env->make('frontend.layoutes', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web\BackEnd\Laravel\Revesion-hospital\resources\views/frontend/home.blade.php ENDPATH**/ ?>